 ...
 */
public class Authentification extends AbstractAccountAuthenticator {
    ...
    public Bundle addAccount(AccountAuthenticatorResponse response, String accountType,
        ...
        final Intent intent = new Intent(mContext, AuthentificationActivity.class);
    ...
    public Bundle getAuthToken(AccountAuthenticatorResponse response, Account account,
        ...
        // return an error
        if (!authTokenType.equals(ConstantsAuthentification.AUTHTOKEN_TYPE)) {
        ...
        if (password != null) {
            final String authToken = org.gdocument.gchattoomuch.util.NetworkUtilities.authenticate(account.name, password);
            if (!TextUtils.isEmpty(authToken)) {
                final Bundle result = new Bundle();
                result.putString(AccountManager.KEY_ACCOUNT_NAME, account.name);
                result.putString(AccountManager.KEY_ACCOUNT_TYPE, ConstantsAuthentification.ACCOUNT_TYPE);
        ...
        final Intent intent = new Intent(mContext, AuthentificationActivity.class);
        intent.putExtra(AuthentificationActivity.PARAM_USERNAME, account.name);
        intent.putExtra(AuthentificationActivity.PARAM_AUTHTOKEN_TYPE, authTokenType);
        intent.putExtra(AccountManager.KEY_ACCOUNT_AUTHENTICATOR_RESPONSE, response);
        final Bundle bundle = new Bundle();
        bundle.putParcelable(AccountManager.KEY_INTENT, intent);
        return bundle;
